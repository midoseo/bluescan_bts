...
export const DEMO_CONSULTANTS = [
  ...
  { empno: '0232950006', name: '강민재', branch: '서강지사', role: 'consultant' },
  { empno: '0232950007', name: '조유진', branch: '서강지사', role: 'consultant' },
  { empno: '0232950008', name: '윤서준', branch: '서강지사', role: 'consultant' },
  { empno: '0232950009', name: '임채원', branch: '서강지사', role: 'consultant' },
  { empno: '0232950010', name: '한지민', branch: '서강지사', role: 'consultant' },
  { empno: '0232950011', name: '오현우', branch: '서강지사', role: 'consultant' },
  { empno: '0232950012', name: '서다은', branch: '서강지사', role: 'consultant' },
  { empno: '0232950013', name: '신준영', branch: '서강지사', role: 'consultant' },
  { empno: '0232950014', name: '권나윤', branch: '서강지사', role: 'consultant' },
  { empno: '0232950015', name: '황태경', branch: '서강지사', role: 'consultant' },
];
